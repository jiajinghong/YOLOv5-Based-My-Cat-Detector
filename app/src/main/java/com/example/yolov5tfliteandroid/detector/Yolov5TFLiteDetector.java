...
public class Yolov5TFLiteDetector {
    ...
    private final int[] OUTPUT_SIZE = new int[]{1, 6300, 7};
    ...
    private final String MODEL_YOLOV5S = "best-fp16_yolov5s.tflite";

    private final String MODEL_YOLOV5N =  "best-fp16_yolov5n.tflite";
    private final String MODEL_YOLOV5M = "best-fp16_yolov5m.tflite";
    private final String MODEL_YOLOV5l = "best-fp16_yolov5l.tflite";
    ///private final String LABEL_FILE = "coco_labe l.txt";
